...
def lidar_com_requisicao(socket_cliente, diretorio):
    ...
    caminho_arquivo = diretorio + partes_requisicao[1]
    ...
    if metodo == "GET":
        if partes_requisicao[1] == "/HEADER":
            ...
            for nome_arquivo in lista_arquivos:
                link_arquivo = '<a href="{}">{}</a><br>'.format(nome_arquivo, nome_arquivo)
...
if __name__ == "__main__":
    porta = 8000
    diretorio = "/Users/Gabriel/Desktop/redes/flavio"  # Coloque o diretório desejado aqui
